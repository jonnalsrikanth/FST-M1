...
//	        Wait for success message to appear and print it to the console.
	      //*[@id="full-name-b25d"]
	        ...
	        d.findElement(By.xpath("//input[starts-with(@id, 'full-name')]")).sendKeys("Srikanth J");

	        // Enter the email into the input field whose ID contains '-email'
	        d.findElement(By.xpath("//input[contains(@id, '-email')]")).sendKeys("test@gmail.com");

	        // Enter the event date into the input field whose name contains '-event-date'
	        d.findElement(By.xpath("//input[contains(@name, '-event-date')]")).sendKeys("2025-01-01");

	        // Enter additional details into the textarea whose ID contains 'additional-details'
	        d.findElement(By.xpath("//textarea[contains(@id, 'additional-details')]")).sendKeys("sample text");
