...
public class Activity13 {
	...
	public static void main(String[] args) {
		...
		Scanner scan = new Scanner(System.in);//used to accept the values from user in console
		...
		int genidx=ran.nextInt(array.size() - 1); //-1 is used since the index starts from 0
